...
# Deterministic framing from the original PSD canvas.
# Every part was positioned relative to the canvas centre, so camera centre must be (0,0).
cam.location=(0.0,0.0,20.0)
aspect=sc.render.resolution_x/sc.render.resolution_y
canvas_h=H/PPU
canvas_w=W/PPU
cd.ortho_scale=max(canvas_h, canvas_w/aspect)*1.04
