...
sc=bpy.context.scene;sc.render.engine='BLENDER_EEVEE_NEXT';sc.render.resolution_x=230;sc.render.resolution_y=350;sc.render.resolution_percentage=100;sc.render.film_transparent=False
if sc.world is None:
...
import base64
for fn in ['Yaw_N20_REAL.png','Yaw_0_REAL.png','Yaw_P20_REAL.png']:
    data=base64.b64encode((OUT/fn).read_bytes()).decode('ascii')
    print('B64BEGIN',fn,len(data))
    for i in range(0,len(data),3000):
        print('B64',fn,i//3000,data[i:i+3000])
    print('B64END',fn)
print('RENDER_DONE_QA',OUT)
